from checking_of_valid_number_combination import check_all_mappings , check_mapping_for_A , check_mapping_for_B 
from checking_of_valid_number_combination import check_mapping_for_C , check_mapping_for_D , check_mapping_for_E
from checking_of_valid_number_combination import mappings , mapping
...
with open("output11.txt", "w") as file:
    for mapping in valid_mappings:
        A_values, B_values, C_values, D_values, E_values = get_ABCDE_from_mapping(mapping)
    if len(A_values) > 1:
